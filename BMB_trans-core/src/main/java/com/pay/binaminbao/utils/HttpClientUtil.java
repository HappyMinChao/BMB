...
public class HttpClientUtil{
    ...
    public static void main(String[] args) {
        ...
        //String getResult = HttpClientUtil.sendPost(url, params, proxySet);
        String getResult = HttpClientUtil.sendGet(url,params,false);
    ...
    public static SSLContext MyX509TrustManagerUtils() {
        ...
        TrustManager[] tm = { new HttpClientUtil().new MyX509TrustManager() };
        SSLContext ctx = null;
        try {
